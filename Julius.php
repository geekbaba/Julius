...
final class Julius {
	...
	public static function init() {
		...
		$inc_path = JULIUS_PATH . 'Common' . self::DS . self::PS
		. JULIUS_PATH . 'Exception' . self::DS . self::PS
		. JULIUS_PATH . 'Util' . self::DS . self::PS
		. JULIUS_PATH . 'Core' . self::DS . self::PS
		. JULIUS_PATH . 'Core' . self::DS . 'Dispatcher' . self::DS . self::PS
		. JULIUS_PATH . 'Core' . self::DS . 'Library' . self::DS . self::PS
		. JULIUS_PATH . 'Core' . self::DS . 'TemplateEngine' . self::DS . self::PS
		. JULIUS_PATH . 'Core' . self::DS . 'Doc' . self::DS . self::PS
		. JULIUS_PATH . 'Core' . self::DS . 'Doc' . self::DS . 'Template' . self::DS . self::PS
		...
		foreach ($list as $pt){
			...
			if('.'!=$pt && '..'!=$pt){
				...
				if(is_dir($path.self::DS.$pt)){
					...
					self::buildFile($path.self::DS.$pt);
				}else{
